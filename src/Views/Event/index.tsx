...
export const Event = () => {
  ...
  const state = useSelector((state: RootState) => state.event.events);
  const sliderRef = useRef<Slider>(null)

  const handleClick = (id: string) => {
    // dispatch(updateValue({ text: 'Chi tiết', path: '/chitiet' }))
    navigate(`/chitiet/${id}`);
  }
  ...
  return (
    <div className={styles.event}>
      ...
      <div className={styles.decorativeWireLeft} ></div>
      <div className={styles.decorativeWireRight} ></div>
                ...
                return (
                  <div key={item.id} className={styles.card}>
                    ...
                    <div>
                      ...
                      <p className={styles.textPlace}>{item.place}</p>
      ...
      <div className={styles.frameOne}></div>
    </div>
  );
};
